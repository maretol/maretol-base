/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 5e36800a1deb390843981081885eb426)
// Runtime types generated with workerd@1.20260815.1 2025-05-05 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	ENV: "STG" | "PRD";
	PAGES_HOST: "https://maretol-base-v3-stg.maretol-ruha.workers.dev" | "https://www.maretol.xyz";
	SNS_NOTIFY_ENABLED: "false" | "true";
	SNS_PUBLISHER: Fetcher /* sns-article-publisher-stg */ | Fetcher /* sns-article-publisher */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		ENV: "STG";
		PAGES_HOST: "https://maretol-base-v3-stg.maretol-ruha.workers.dev";
		SNS_NOTIFY_ENABLED: "false";
		SNS_PUBLISHER: Fetcher /* sns-article-publisher-stg */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "PAGES_HOST" | "SNS_NOTIFY_ENABLED">> {}
}
