...
- [x] ステージング検証（PR #1124 マージ → #1125 のstgデプロイ後、一覧/詳細/タグ絞り込み/限定公開/info を確認済み 2026-07-11）
- [x] 本番切替（PR #1126 → #1125 マージで本番デプロイ、動作確認済み 2026-07-11。**サイト全体が microCMS 非依存になった**）
- [ ] 撤去の前提: cms-cache-purger の運用機能（手動パージ）を admin-pages のキャッシュ管理ページに移行
- [ ] 新規記事公開時のSNS自動投稿の実弾確認（RPC経路の初回）
